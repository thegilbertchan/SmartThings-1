...
metadata {
	...
	definition (name: "Better Thermostat with battery and time", author: "Danny C") {
	...
	tiles {
		...
		main "temperature"
		details(["temperature", "mode", "fanMode", "heatLevelDown", "heatingSetpoint", "heatLevelUp", "coolLevelDown", "coolingSetpoint", "coolLevelUp", "refresh", "configure", "battery"])
	}
}
